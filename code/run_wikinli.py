...
def load_and_cache_examples(args, task, tokenizer, evaluate=False):
    ...
    if os.path.exists(cached_features_file) and not args.overwrite_cache:
        ...
        examples = processor.get_dev_examples(args.data_dir) if evaluate else processor.get_train_examples(args.data_dir, args.num_train_examples)
...
def main():
    ...
    parser.add_argument("--task_name", default=None, type=str, required=True, choices=["wikinli", "wikinlifourway", "wikinlibinary"],
                        help="The name of the task to train selected in the list: " + ", ".join(processors.keys()))
    parser.add_argument("--output_dir", default=None, type=str, required=True,
                        help="The output directory where the model predictions and checkpoints will be written.")
    parser.add_argument("--num_train_examples", default=24000, type=int, required=True,
                        help="The number of training examples loaded")
    ...
    parser.add_argument('--resume_training', action='store_true', help="Whether to resume training from existing checkpoint.")
    ...
    all_output_eval_file = os.path.join(args.output_dir, "all_eval_results.txt")
    with open(all_output_eval_file, "w") as writer:
        logger.info("***** Eval all results *****")
